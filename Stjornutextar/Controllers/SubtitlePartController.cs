...
namespace Stjornutextar.Controllers
{
    public class SubtitlePartController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="ID,PartNumber,Time")] SubtitlePart subtitlepart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ID,PartNumber,Time")] SubtitlePart subtitlepart)
        {
            if (ModelState.IsValid)
            {
